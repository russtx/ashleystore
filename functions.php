...
if (function_exists('add_theme_support'))
{
	...
	'default-color' => 'FFF',
	'default-image' => get_template_directory_uri() . '/assets/images/sand-bg.jpg'
    ));

    // Add Support for Custom Header - Uncomment below if you're going to use
    add_theme_support('custom-header', array(
	'default-image'			=> get_template_directory_uri() . '/assets/images/header/default.png',
	'header-text'			=> false,
...
function create_post_type_html5()
{
    ...
    register_post_type('pricing', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Prices', 'pricing'), // Rename these to suit
            'singular_name' => __('Price', 'pricing'),
            'add_new' => __('Add New', 'pricing'),
            'add_new_item' => __('Add New Prices', 'pricing'),
            'edit' => __('Edit', 'pricing'),
            'edit_item' => __('Edit Price', 'pricing'),
            'new_item' => __('New Prices', 'pricing'),
            'view' => __('View Prices', 'pricing'),
            'view_item' => __('View Prices', 'pricing'),
            'search_items' => __('Search Prices', 'pricing'),
            'not_found' => __('No Pricess found', 'pricing'),
            'not_found_in_trash' => __('No Pricess found in Trash', 'pricing')
        ),
